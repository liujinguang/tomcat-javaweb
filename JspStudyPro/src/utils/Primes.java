...
public class Primes {
	...
	/**
	 * Create a random big integer where every digit is selected randomly
	 * (except that the first digit cannot be a zero).
	 */
	...
	/**
	 * Simple command-line program to test. Enter number of digits, and the
	 * program picks a random number of that length and then prints the first 50
	 * prime numbers above that.
	 */
